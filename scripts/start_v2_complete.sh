...
echo "🚀 A2A Sentiment Analysis System V2 시작..."
...
cleanup() {
    ...
    pkill -f "uvicorn.*3000" 2>/dev/null  # MCP Server
...
# 2. MCP Server Simulator 시작
start_service "MCP Server Simulator" "mcp_server_simulator:app" 3000

# 3. Main Orchestrator V2 시작
start_service "Main Orchestrator V2" "main_orchestrator_v2:app" 8100
...
echo -e "${YELLOW}📌 MCP Server: http://localhost:3000${NC}"
echo -e "${YELLOW}📌 A2A 프로토콜과 MCP가 활성화되었습니다!${NC}"
echo ""
